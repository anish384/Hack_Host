...
def get_db():
    if 'db' not in g:
        mongo_uri = current_app.config.get('MONGO_URI', 'mongodb+srv://anishdesai:264742@cluster0.ijfacnv.mongodb.net/StarterFlask?retryWrites=true&w=majority&appName=Cluster0')
